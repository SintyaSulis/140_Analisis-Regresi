...
data <- read_excel("/Users/sintyasulis/Downloads/NSC-2025 (1).xlsx", sheet="Sheet2")
...
$$\hat{Y} = 74.26 + 0.00002295 X_2$$

dengan Y adalah Indeks Pembangunan Manusia (IPM) dan X2 adalah PDRB ADHK (miliar rupiah).

Didapatkan nilai $\hat\beta_0 = 74.26$ yang menunjukkan nilai dugaan rataan IPM ketika PDRB ADHK bernilai 0, akan tetapi nilai 0 tidak ada dalam selang pengamatan PDRB ADHK sehingga $\hat\beta_0$ tidak dapat didefinisikan lebih lanjut

Nilai $\hat\beta_1 = 0.00002295$ artinya setiap kenaikan PDRB ADHK sebesar 1 miliar rupiah akan meningkatkan dugaan rataan IPM sebesar 0.00002295

Koefisien determinasi yang dihasilkan adalah 0.2098 atau 20.98%, yang berarti bahwa 20.98% keragaman IPM dapat dijelaskan oleh PDRB ADHK, sedangkan 79.02% sisanya dijelaskan oleh faktor lain yang tidak dimasukkan dalam model.
